...
public class TicTacToeButton extends Button {
	...
	private final String FONT_PATH = "src/fonts/SMW2-Yoshis-Island.ttf";
	//private final String FONT_PATH_2 = "src/fonts/MachineGunk-nyqg.ttf";
	...
	public TicTacToeButton(String text) {
